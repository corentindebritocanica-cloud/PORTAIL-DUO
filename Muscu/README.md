...
| Progression — Entraînement | menu déroulant, tonnage par séance, période, écart, étiquettes, absence de doublon avec l'onglet Corps, **filtre par méthode (clé composée, sélection automatique de la 1ʳᵉ méthode, pas de vue mélangée), courbe animée (aire, lissage, points en cascade)** |
